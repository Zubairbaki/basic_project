            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Portfoli Edit Page</h4>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="protfolio_name"  value="{{$portfolio->protfolio_name}}" type="text" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="protfolio_title" value="{{$portfolio->protfolio_title}}" type="text"  id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="elm1" name="protfolio_description">{{$portfolio->protfolio_description}}"</textarea>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-2">
                                    <img class="card-img-top img-fluid" id="showImage"
                                        src="{{ asset($portfolio->protfolio_image) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="btn btn-info waves-effect waves-light"   value="Update  Protfolio Data" type="Submit"  id="example-text-input">
                            </div>
                        </div>
                    </form>
